...
import {
  ...
  insertExperience,
  updateExperience,
} from "../modules/experiencesFetches";
...
function CardEsperienza() {
  ...
  const [nuovaEsperienza, setNuovaesperienza] = useState({
    role: "",
    company: "",
    area: "",
    startDate: "",
  ...
  const [modificaEsperienza, setModificaesperienza] = useState({
    role: "",
    company: "",
    area: "",
    startDate: "",
          ...
          <div>
            {URLParams.profileId === "me" ? (
              <>
                ...
                {!isEditing && (
                  <FaPen className="ms-3" onClick={toggleEditMode} />
                )}
              </>
            ) : (
              ""
        ...
        {esperienza.map((data) => (
          <Container fluid className="mt-3" key={data._id}>
            <Row className="w-100">
              <Col
                xs={2}
                className="d-flex align-items-start justify-content-end pt-2"
              >
                <FaBriefcase />
              </Col>
